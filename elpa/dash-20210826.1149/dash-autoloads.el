...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dash" '("dash-" "-keep" "-butlast" "-zip" "-e" "->" "-gr" "-when-let" "-d" "-l" "-s" "-m" "-u" "-value-to-list" "-t" "--" "-juxt" "-r" "-no" "-o" "-a" "-i" "-c" "-f" "-p" "!cons" "!cdr")))
